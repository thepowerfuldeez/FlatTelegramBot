...
whole_users = pickle.load(open("whole_users.p", "rb"))
...
def parse_vk_feeds(bot, update):
    logger.info("Start parsing many many vk feeds")
    for i in range(0, len(whole_users), 10000):
        users = whole_users[i:i+10000]
